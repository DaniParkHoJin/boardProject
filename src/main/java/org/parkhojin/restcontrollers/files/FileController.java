package org.parkhojin.restcontrollers.files;
...
import org.parkhojin.models.file.FileDownloadService;
import org.parkhojin.models.file.FileUploadService;
...
public class FileController {
     ...
     */
    @PostMapping("/upload")
    public ResponseEntity<JSONData<List<FileInfo>>> uploadPs(@RequestParam(value = "files",required = false) MultipartFile[] files, @RequestParam(value = "gid", required = false) String gid, @RequestParam(value = "location", required = false) String location) {
